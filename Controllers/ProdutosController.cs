...
namespace lucas_gabriel.Controllers
{
    public class ProdutosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,Desc,Qtd,Preco,MarcaId")] Produto produto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,Desc,Qtd,Preco,MarcaId")] Produto produto)
        {
            if (id != produto.Id)
            {
                return NotFound();
